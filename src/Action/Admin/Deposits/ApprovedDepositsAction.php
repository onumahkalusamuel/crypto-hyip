...
final class ApprovedDepositsAction
{
    private $deposits;
    ...
    public function __invoke(
        ...
        $params['depositStatus'] = "approved";
        if (!empty($_GET['userName'])) $params['userName'] = $_GET['userName'];
        if (!empty($_GET['page'])) $params['page'] = $_GET['page'];
        $params['rpp'] = 20;
        // Invoke the Domain with inputs and retain the result
        $deposit = $this->deposits->depositList($params);
