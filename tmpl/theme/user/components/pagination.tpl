    ...
    <ul class="pagination">
        <li class="page-item">
            <a href="{$links.first_page_link}"
                class="prev page-link {if $links.first_page_link === $links.current_page_link}disabled readonly{/if}">&lt;&lt;</a>
        </li>
        ...
        <li class="page-item"><a href="{$links.last_page_link}"
                class="next page-link {if $links.last_page_link === $links.current_page_link}disabled readonly{/if}">&gt;&gt;</a>
        </li>
    </ul>
{/if}
